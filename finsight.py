...
# ── SYSTEM PROMPT ─────────────────────────────────────────────────────────────
#added prompts:
#go through all the companies that all the documents are about
#Conduct a deep search of the documents regardless of the language used in the user's query. If the user indicates they "cannot understand English," translate the core financial data retrieved from the English reports into the language of the question and explain it in plain, easy-to-understand terms.
...
#If the question is to evaluate based on certain index, you must provide any related data based on the document also include data in markdown tables, you must also give necessary calculation and show relevant values to support your result.
